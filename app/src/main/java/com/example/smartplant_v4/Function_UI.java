...
public class Function_UI extends AppCompatActivity {

    private TextView resultTextView_weather;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_function_ui);

//            cityEditText = findViewById(R.id.cityEditText);
//            areaEditText = findViewById(R.id.areaEditText);
            resultTextView_weather = findViewById(R.id.textView_weather);
...
//            new WeatherTask().execute(openDataUrl, city, area);
        new WeatherTask().execute(openDataUrl, "桃園市", "楊梅區");
        }
...
//
////            new WeatherTask().execute(openDataUrl, city, area);
//            new WeatherTask().execute(openDataUrl, "臺南市", "安平區");
//
//        }
        ...
        private class WeatherTask extends AsyncTask<String, Void, String> {
                    ...
                    if (responseCode == 200) {
                        ...
                        for (int i = 0; i < locationArray.length(); i++) {
                            ...
                            if (name.equals(city)) {
                                ...
                                cityData.put(cityArea, city+area+"\n"+temp + " 度, 相對濕度 " + humd + "%, 天氣 " + weather);
            ...
            protected void onPostExecute(String result) {
                resultTextView_weather.setText(result);
            }
        }
    }